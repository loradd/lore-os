...
impl Writer {
    ...
    pub fn write_string(&mut self, s: &str) {
        for byte in s.bytes() {
            match byte {
                // printable ASCII byte or newline or tab or backspace
    ...
    pub fn write_byte(&mut self, byte: u8) {
        match byte {
            ...
            byte => {
                ...
                self.buffer.chars[row_position][column_position].write(ScreenChar {
    ...
    fn insert_line(&mut self) {
        for row_position in 1..BUFFER_HEIGHT {
